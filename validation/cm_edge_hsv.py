...
import predict.predict_model_edge_hsv as fungsi
...
plt.text(0.5, 1.1, 'Accuracy: {:.2f}'.format(accurasy), horizontalalignment='center', verticalalignment='center', transform=plt.gca().transAxes)
